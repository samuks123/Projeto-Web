...
const AddProperty = () => {
    ...
    return(
        ...
        <div className="text-4xl text-center m-3">Add Property</div>
        <form onSubmit={async (e)=>{
            e.preventDefault()
            const result = await createHouseData(data)
            if (data) {
                navigate("/")
            }
                ...
                <div className="mb-4">
                    ...
                    {data.image?
                    <img className="h-40 object-contain" src={data.image} alt="image"/>
                    :<></>
                    }
                    <input
                        type="file"
                ...
                <div className="mb-4">
                    ...
                    {data.agent.image?
                    <img className="h-40 object-contain" src={data.agent.image} alt="image"/>
                    :<></>}
                    <input
                        type="file"
                        id="agentImage"
