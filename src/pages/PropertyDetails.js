                ...
                <div className='flex flex-col items-start gap-8 lg:flex-row'>
                    ...
                    <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
                        ...
                        <form className='flex flex-col gap-y-4'>
                            ...
                            placeholder='Phone*'
                            />
                            <textarea className='border border-gray-300 focus:boder-violet-700 outiline-none resize-none rounded w-full p-4 h-35 text-sm text-gray-400' placeholder='Message*'
                            ...
                            <div className='flex gap-x-2'>
                                ...
                                <button className='border border-violet-700 teaxt-violet-700 hover:border-violet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition'>Call</button>
                            </div>
                        </form>
                    </div>
                </div>
